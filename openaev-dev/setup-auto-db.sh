...
echo "╚══════════════════════════════════════════════════════════════╝"
echo ""
echo "  The backend will now auto-start a PostgreSQL Docker container"
echo "  when launched with the 'dev' profile and the property:"
echo ""
...
echo ""
echo "  Both properties go in application-dev.properties."
echo ""
