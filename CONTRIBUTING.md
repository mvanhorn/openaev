...
Do not hesitate to shoot us an [email](mailto:contact@filigran.io) or join us on our [Slack channel](https://community.filigran.io). Most of the articles below are an introduction for our [detailed documentation](https://docs.openaev.io).


## Why contribute?

OpenAEV is an open source platform allowing organizations to plan, schedule and conduct cyber adversary simulation campaigns and tests. It allows security teams to validate their defenses, train their analysts and measure their detection and response capabilities against real-world attack scenarios (if you want to know more about OpenAEV, you can read the [detailed documentation](https://docs.openaev.io) or try it on the [demonstration platform](https://demo.openaev.io/)).
...
* Don't hesitate to flag us an issue with the documentation or the templates if you find them incomplete or not clear enough. You can do that either by opening a [bug report](https://github.com/OpenAEV-Platform/openaev/issues/new?assignees=&labels=&template=bug_report.md&title=) or by sending us a message on our [Slack channel](https://community.filigran.io).
...
If you need support or you wish to engage a discussion about the OpenAEV platform, feel free to join us on our [Slack channel](https://community.filigran.io). You can also send us an [email](mailto:contact@filigran.io).
